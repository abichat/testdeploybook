...
%%%
\hfill
\hspace*{-0.4cm}{\small {\bf NNT~: 2020SACLY000}}
%%%
...
%%%
\hfill
\hbox{\includegraphics[width=2cm]{logos/ueve.jpg}}
\vspace{7mm}
\begin{center}
...
%%%
{\small \it Établissement d'inscription~:} Université d'Évry-Val d'Essonne
...
%%%
{\small \it Laboratoire d'accueil~:} Laboratoire de Mathématiques et Modélisation d'Évry, UMR 8071 CNRS-INRA
...
%%  Spécialité
%%%
{\it Spécialité de doctorat~:} {\large Mathématiques appliquées}
\end{center}
\vspace{5mm}
\begin{center}
{\large\bf Antoine BICHAT}
\end{center}
\vspace{3mm}
\begin{center}
{\Large Test de déploiement}
%%%
...
\noindent{\small \it Date de soutenance~:} 14 mai
...
\begin{tabular}{l}
{\sc Prénom NOM 1} (Institution 1)\vspace{1mm}  \\
{\sc Prénom NOM 2} (Institution 2)\\
\end{tabular}
\vspace{8mm}
...
%%%%
\begin{tabular}{ll}
{\sc   Prénom NOM 1}&(Institution 1) {\small Rapporteur}\vspace{1mm}\\
{\sc   Prénom NOM 2}&(Institution 2) {\small Codirecteur de thèse}\vspace{1mm}\\
{\sc   Prénom NOM 3}&(Institution 3) {\small Examinateur}\vspace{1mm}\\
{\sc   Prénom NOM 4}&(Institution 4) {\small Examinateur}\vspace{1mm}\\
{\sc   Prénom NOM 5}&(Institution 4) {\small Codirecteur de thèse}\vspace{1mm}\\
{\sc   Prénom NOM 6}&(Institution 6) {\small Invité}\vspace{1mm}\\
\end{tabular}
...
\hbox{\includegraphics[width=1.5cm]{logos/lamme.jpg}}
%%%
...
This is a test for \emph{Bookdown} deployment with GitHub Actions.
...
\newpage
\pagestyle{empty}
\hbox{\includegraphics[width=8cm]{logos/edmhsaclay.jpg}}


\bigskip
\noindent\fbox{\parbox{\textwidth}{
{\bf Titre :} Test de déploiement

\medskip
{\bf Mots Clefs :} Mettre de 3 à 6 mots clefs

\medskip
{\bf Résumé :} Résumé en français
...
\bigskip
\noindent\fbox{\parbox{\textwidth}{
{\bf Title:} Deployment test

\medskip
{\bf Keys words:} 3 to 6 key words

\medskip
{\bf Abstract:} Abstract in english
