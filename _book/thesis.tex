...
%%%
\hfill
\hbox{\includegraphics[width=3cm]{logos/upsud.jpg}}
\vspace{7mm}
\begin{center}
...
%%%
{\small \it Établissement d'inscription~:} Université Paris-Sud

 \vspace*{0.2cm}
%%%
%% nom établissement(s) d'accueil, si différent du précédent
%%%
{\small \it Établissement d'accueil~:} Institut des Hautes Études Scientifiques

\vspace*{0.2cm}
%%%
%% nom laboratoire(s) d'accueil
%%%
{\small \it Laboratoire d'accueil~:} Laboratoire Alexander Grothendieck (ERL 9216 CNRS)
...
%%  Spécialité
%%%
{\it Spécialité de doctorat~:} {\large Mathématiques fondamentales}
\end{center}
\vspace{5mm}
\begin{center}
...
\noindent{\small \it Date de soutenance~:} Jour Mois Année
...
\hbox{\includegraphics[width=2cm]{logos/ihes.jpg}}
%%%
%% logo laboratoire d'accueil, s'il existe
%%%
\hfill\hfill\hfill\hfill
\hbox{\includegraphics[width=2cm]{logos/lag.jpg}}
%%%
...
{\bf Titre :} Titre de la thèse

\medskip
{\bf Mots Clefs :} Mettre de 3 à 6 mots clefs

\medskip
{\bf Résumé :} Réumé en français
